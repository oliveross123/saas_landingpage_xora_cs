export const features = [
  {
    ...
    caption: "Snadná integrace",
    title: "Pracujte chytře, ne tvrdě",
    text: "S Xora jsou nudné úkoly minulostí. Automatizace a chytré procesy zvýší vaši produktivitu na nové úrovně. Je to jako mít navíc šálek kávy, ale bez třesu.",
    button: {
  ...
  },
  {
    ...
    caption: "Bezpečné a důvěryhodné",
    title: "Klidně spěte, máme vás kryté",
    text: "Vaše datová bezpečnost je naší prioritou. Díky špičkovému šifrování a robustním kontrolám soukromí Xora pomáhá udržet vaše informace v bezpečí a chráněné lépe než Fort Knox.",
    button: {
      icon: "/images/docs.svg",
      title: "Nahlédnout do dokumentace",
    },
  },
];
...
export const details = [
  {
    ...
    title: "AI automatizované video úpravy",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Spolupracujte se svým týmem",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Velmi rychlý cloudový motor",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "24/7 Zákaznická podpora",
  },
];
...
export const faq = [
  {
    id: "0",
    question: "Jak snadné je nastavit Xoru?",
    answer:
      "Rozhodně! Nejen, že můžete kdykoli upgradovat svůj plán, ale také získáte poměrnou slevu, která vám poskytne maximální hodnotu za vaše předplatné.",
  },
  {
    id: "1",
    question: "Mohu integrovat Xoru s jinými platformami?",
    answer:
      "Rozhodně! Nejen, že můžete kdykoli upgradovat svůj plán, ale také získáte poměrnou slevu, která vám poskytne maximální hodnotu za vaše předplatné.",
  },
  {
    id: "2",
    question: "Jak často přidáváte nový obsah?",
    answer:
      "Rozhodně! Nejen, že můžete kdykoli upgradovat svůj plán, ale také získáte poměrnou slevu, která vám poskytne maximální hodnotu za vaše předplatné.",
  },
  {
    id: "3",
    question: "Jaká je vaše politika vrácení peněz?",
    answer:
      "Rozhodně! Nejen, že můžete kdykoli upgradovat svůj plán, ale také získáte poměrnou slevu, která vám poskytne maximální hodnotu za vaše předplatné.",
  },
  {
    id: "4",
    question: "Nabízíte firemní plány?",
    answer:
      "Rozhodně! Nejen, že můžete kdykoli upgradovat svůj plán, ale také získáte poměrnou slevu, která vám poskytne maximální hodnotu za vaše předplatné.",
  },
  {
    id: "5",
    question: "Co se stane, když mi dojde úložiště?",
    answer:
      "Rozhodně! Nejen, že můžete kdykoli upgradovat svůj plán, ale také získáte poměrnou slevu, která vám poskytne maximální hodnotu za vaše předplatné.",
  },
  {
    id: "6",
    question: "Mohu upgradovat svůj plán?",
    answer:
      "Rozhodně! Nejen, že můžete kdykoli upgradovat svůj plán, ale také získáte poměrnou slevu, která vám poskytne maximální hodnotu za vaše předplatné.",
  },
  {
    id: "7",
    question: "Jak pozvu svůj tým?",
    answer:
      "Rozhodně! Nejen, že můžete kdykoli upgradovat svůj plán, ale také získáte poměrnou slevu, která vám poskytne maximální hodnotu za vaše předplatné.",
  },
  {
    id: "8",
    question: "Nabízíte školení pro jednotlivce a týmy?",
    answer:
      "Rozhodně! Nejen, že můžete kdykoli upgradovat svůj plán, ale také získáte poměrnou slevu, která vám poskytne maximální hodnotu za vaše předplatné.",
  },
  {
    id: "9",
    question: "Nemohu se přihlásit do svého účtu, co mám dělat?",
    answer:
      "Rozhodně! Nejen, že můžete kdykoli upgradovat svůj plán, ale také získáte poměrnou slevu, která vám poskytne maximální hodnotu za vaše předplatné.",
  },
];
...
export const plans = [
  {
    ...
    priceMonthly: 19,
    priceYearly: 12,
    caption: "Nejlepší pro sólové tvůrce",
    features: [
      "100MB Cloudového úložiště",
      "100+ šablon promptů",
      "5 projektů",
      "Podpora 24/7",
    ],
  ...
  },
  {
    ...
    priceMonthly: 79,
    priceYearly: 59,
    caption: "Nejoblíbenější plán",
    features: [
      "Všechny funkce Starter",
      "1TB dalšího úložiště",
      "Neomezené projekty",
      "Analýzy",
    ],
  ...
  },
  {
    ...
    priceMonthly: 39,
    priceYearly: 29,
    caption: "Exkluzivně pro týmy",
    features: [
      "Všechny funkce Overdrive",
      "10TB dalšího úložiště",
      "50% sleva na člena",
...
export const testimonials = [
  {
    ...
    comment:
      "Zákaznická podpora Xory je bezkonkurenční! Jsou jako moji technologiští superhrdinové, vždy tam, když je potřebuji.",
  },
  {
    id: "1",
    name: "Petr Dvořák",
    ...
    comment:
      "Byl jsem zpočátku skeptický, ale teď si nedokážu představit naše obsahové operace bez toho. Je to tak přínosné.",
  },
  {
    id: "2",
    name: "Lucie Hrušková",
    ...
    comment:
      "Přijetí tohoto softwaru bylo snadné. Zjednodušilo to každodenní úkoly.",
  },
  {
    id: "3",
    name: "Alena Bartošová",
    role: "Cyberleap",
    avatarUrl: "/images/testimonials/alicia-barker.png",
    comment:
      "Funkce analýz je jako mít osobního věštce. Byla klíčová při vedení našich obchodních rozhodnutí.",
  },
  {
    id: "4",
    ...
    comment:
      "Přešla jsem na Xoru minulý měsíc a už teď vidím výsledky. Nejlepší rozhodnutí pro náš tým!",
  },
  {
    id: "5",
    name: "Jiří Novák",
    ...
    comment:
      "Nárůst efektivity je nepopiratelný. Tato platforma navždy změnila náš pracovní postup.",
  },
];
...
export const socials = [
  ...
  },
  {
    ...
    url: "https://www.instagram.com/rvltn.cz/",
  },
  {
    id: "3",
    title: "Discord",
